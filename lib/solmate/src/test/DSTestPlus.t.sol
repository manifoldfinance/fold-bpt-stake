...
contract DSTestPlusTest is DSTestPlus {
    ...
    function testFuzzBound(uint256 num, uint256 min, uint256 max) public {
    ...
    function testFailFuzzBoundMinBiggerThanMax(uint256 num, uint256 min, uint256 max) public {
        if (max == min) {
            unchecked {
