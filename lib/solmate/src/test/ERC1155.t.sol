...
contract ERC1155Test is DSTestPlus, ERC1155TokenReceiver {
    ...
    function testFuzzMintToEOA(address to, uint256 id, uint256 amount, bytes memory mintData) public {
    ...
    function testFuzzMintToERC1155Recipient(uint256 id, uint256 amount, bytes memory mintData) public {
        ERC1155Recipient to = new ERC1155Recipient();
    ...
    function testFailFuzzMintToZero(uint256 id, uint256 amount, bytes memory data) public {
        token.mint(address(0), id, amount, data);
    }

    function testFailFuzzMintToNonERC155Recipient(uint256 id, uint256 mintAmount, bytes memory mintData) public {
        token.mint(address(new NonERC1155Recipient()), id, mintAmount, mintData);
    }

    function testFailFuzzMintToRevertingERC155Recipient(uint256 id, uint256 mintAmount, bytes memory mintData) public {
    ...
    function testFailFuzzBatchMintToZero(uint256[] memory ids, uint256[] memory amounts, bytes memory mintData) public {
        uint256 minLength = min2(ids.length, amounts.length);
